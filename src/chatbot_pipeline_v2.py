...
class ChatbotPipeline:
    ...
    def _generate_response(self, products: List[Dict], language: str, query_english: str) -> str:
    ...
    def process_message(self, user_input: str) -> Dict:
        ...
        products = self._search_products(query_english, max_results=5)
        ...
        response = self._generate_response(products, detected_lang, query_english)
